...
const UI_MESSAGES: Record<AppLocale, Record<string, string>> = {
  en: {
    ...
    "moves.column.priority": "Priority",
    "moves.power.special_damage": "Special",
    ...
    "compare.eyebrow": "Battle Prep",
    "compare.title": "Pokémon Comparison",
    "compare.subtitle": "Select two Pokémon and analyze their stats, type matchup, and move coverage.",
    "compare.pick_pokemon": "Pick a Pokémon",
    "compare.search_placeholder": "Search by name or number",
    "compare.change": "Change",
    "compare.section.statistics": "Statistics",
    "compare.section.type_matchup": "STAB vs Type",
    "compare.section.moves": "Move Effectiveness",
    "compare.select_prompt": "Select both Pokémon above to begin the comparison.",
    "compare.physical": "Physical",
    "compare.special": "Special",
    "compare.offense_vs_defense": "Offense vs Defense",
    "compare.level": "Level",
    "compare.iv": "IV",
    "compare.ev": "EV",
    "compare.stage": "Mod",
    "compare.current_hp": "Current HP %",
    "compare.current_hp_short": "HP%",
    "compare.nature": "Nature",
    "compare.nature_placeholder": "Search nature",
    "compare.nature_neutral": "neutral",
    "compare.clear_nature": "Clear nature",
    "compare.weather": "Weather",
    "compare.weather.clear": "Clear",
    "compare.weather.sun": "Sun",
    "compare.weather.rain": "Rain",
    "compare.weather.sandstorm": "Sandstorm",
    "compare.weather.hail": "Hail",
    "compare.spikes": "Spikes",
    "compare.stealth_rock": "Stealth Rock",
    "compare.entry_hazards": "Entry hazards",
    "compare.status": "Status",
    "compare.status.none": "Healthy",
    "compare.status.burn": "Burned",
    "compare.status.paralysis": "Paralyzed",
    "compare.status.poison": "Poisoned",
    "compare.status.toxic": "Badly Poisoned",
    "compare.status.sleep": "Asleep",
    "compare.status.freeze": "Frozen",
    "compare.ability": "Ability",
    "compare.stab_vs": "STAB attacking {name}",
    "compare.moves_vs": "Moves vs {name}",
    ...
    "compare.damage_range": "Damage",
    "compare.critical": "Critical",
    "compare.residual": "chip",
    "compare.heal": "heal",
    "compare.ohko_block": "blocks OHKO",
    "compare.damage_note": "Lv. {level} · per-stat IV/EV · selected natures/weather/status/abilities · no items or screens.",

    "team.eyebrow": "Battle Prep",
    "team.title": "Team Matchup",
    "team.subtitle": "Build your team and analyze type matchups, weaknesses, and offensive coverage.",
    "team.my_team": "My Team",
    "team.opp_team": "Opponent",
    "team.clear": "Clear",
    "team.search_placeholder": "Add a Pokémon…",
    "team.empty_prompt": "Add Pokémon to your team above to start the analysis.",
    "team.no_opp_prompt": "Add Pokémon to the opponent's team to see the matchup.",
    "team.section.defensive": "Defensive Weaknesses",
    "team.section.defensive_desc": "Attack types that hit at least one team member super effectively, sorted by threat level.",
    "team.section.matchup": "Type Coverage Matchup",
    "team.section.matchup_desc": "STAB effectiveness and type vulnerabilities for both teams.",
    "team.section.stats": "Average Stats",
    "team.my_stab_coverage": "STAB Coverage",
    "team.my_weaknesses": "Type Weaknesses",
    "team.opp_stab_threats": "STAB Coverage",
    "team.opp_weaknesses": "Type Weaknesses",
    "team.matrix.coverage_hint": "coverage against their team",
    "team.matrix.threats_hint": "threats against your team",
    ...
    "team.stored.eyebrow": "Local storage",
    "team.stored.title": "Stored Teams",
    "team.stored.subtitle": "Save your current team locally with IVs, EVs, nature, ability, and up to four known moves per Pokémon.",
    "team.stored.load_subtitle": "Load a local team into either side of the matchup, or edit the saved build details.",
    "team.stored.name_placeholder": "Team name",
    "team.stored.save_current": "Save",
    "team.stored.empty": "No stored teams yet. Add Pokémon to My Team, name the team, then save it here.",
    "team.stored.default_name": "Team {count}",
    "team.stored.expand": "Expand stored team",
    "team.stored.collapse": "Collapse stored team",
    "team.stored.import": "Import",
    "team.stored.load": "Load",
    "team.stored.load_as_my": "Load as my team",
    "team.stored.load_as_opp": "Load as opponent",
    "team.stored.my_short": "My",
    "team.stored.opp_short": "Opp",
    "team.stored.edit": "Edit",
    "team.stored.compare_lead": "Compare lead",
    "team.stored.delete": "Delete",
    "team.stored.compare_a": "Compare A",
    "team.stored.compare_b": "Compare B",
    "team.stored.no_nature": "No nature",
    "team.stored.no_matching_natures": "No matching natures",
    "team.stored.moves": "Known moves",
    "team.stored.move_slot": "Move {slot}",
    "team.stored.move_search_placeholder": "Search move",
    "team.stored.no_matching_moves": "No matching moves",
    "team.stored.no_move": "No move",

    "compare.stored.title": "Stored Builds",
    "compare.stored.subtitle": "Import a locally saved Pokémon build to prefill IVs, EVs, nature, ability, and known moves.",
    "compare.stored.import_a": "Import to A",
    "compare.stored.import_b": "Import to B",
    "compare.stored.none": "Select saved build",
    "compare.stored.known_moves": "Using stored moves",
    "compare.stored.known_move": "Known",

    "team_save.back": "Back to Team",
    "team_save.title_new": "Save Team",
    "team_save.title_edit": "Edit Team",
    "team_save.subtitle": "Name the team and set each Pokémon's IVs, EVs, nature, ability, and known moves.",
    "team_save.save": "Save team",
    "team_save.duplicate": "Duplicate",
    "team_save.duplicate_name": "{name} copy",
    "team_save.add_pokemon": "Add Pokémon",
    "team_save.compare_pokemon": "Compare {name}",
    "team_save.remove": "Remove",
    "team_save.remove_pokemon": "Remove {name}",
    "team_save.team_full": "Team is full",
    "team_save.status_new": "Not saved yet",
    "team_save.status_saved": "No unsaved changes",
    "team_save.status_unsaved": "Unsaved changes",
    "team_save.empty": "No team members were provided. Build a team first, then save it.",
    "team_save.loading_pokemon": "Loading Pokémon",
  },
  it: {
    "brand.tagline": "Walks on water",
    ...
    "moves.column.priority": "Priorità",
    "moves.power.special_damage": "Speciale",
    ...
    "compare.eyebrow": "Prep battaglia",
    "compare.title": "Confronto Pokémon",
    "compare.subtitle": "Seleziona due Pokémon e analizza statistiche, matchup di tipo ed efficacia delle mosse.",
    "compare.pick_pokemon": "Scegli un Pokémon",
    "compare.search_placeholder": "Cerca per nome o numero",
    "compare.change": "Cambia",
    "compare.section.statistics": "Statistiche",
    "compare.section.type_matchup": "STAB vs Tipo",
    "compare.section.moves": "Efficacia mosse",
    "compare.select_prompt": "Seleziona entrambi i Pokémon per iniziare il confronto.",
    "compare.physical": "Fisico",
    "compare.special": "Speciale",
    "compare.offense_vs_defense": "Attacco vs Difesa",
    "compare.level": "Livello",
    "compare.iv": "IV",
    "compare.ev": "EV",
    "compare.stage": "Mod",
    "compare.current_hp": "PS attuali %",
    "compare.current_hp_short": "PS%",
    "compare.nature": "Natura",
    "compare.nature_placeholder": "Cerca natura",
    "compare.nature_neutral": "neutra",
    "compare.clear_nature": "Cancella natura",
    "compare.weather": "Meteo",
    "compare.weather.clear": "Sereno",
    "compare.weather.sun": "Sole",
    "compare.weather.rain": "Pioggia",
    "compare.weather.sandstorm": "Terrempesta",
    "compare.weather.hail": "Grandine",
    "compare.spikes": "Punte",
    "compare.stealth_rock": "Levitoroccia",
    "compare.entry_hazards": "Insidie",
    "compare.status": "Status",
    "compare.status.none": "Normale",
    "compare.status.burn": "Scottato",
    "compare.status.paralysis": "Paralizzato",
    "compare.status.poison": "Avvelenato",
    "compare.status.toxic": "Iperavvelenato",
    "compare.status.sleep": "Addormentato",
    "compare.status.freeze": "Congelato",
    "compare.ability": "Abilità",
    "compare.stab_vs": "STAB vs {name}",
    "compare.moves_vs": "Mosse vs {name}",
    "compare.loading_moves": "Caricamento mosse…",
    "compare.no_damage_moves": "Nessuna mossa offensiva.",
    "compare.immune": "Immune",
    "compare.swap": "Inverti Pokémon",
    "compare.damage_range": "Danno",
    "compare.critical": "Brutto colpo",
    "compare.residual": "chip",
    "compare.heal": "cura",
    "compare.ohko_block": "blocca OHKO",
    "compare.damage_note": "Lv. {level} · IV/EV per statistica · nature/meteo/status/abilità selezionati · senza strumenti o barriere.",

    "team.eyebrow": "Prep battaglia",
    "team.title": "Analisi Team",
    "team.subtitle": "Costruisci il tuo team e analizza matchup di tipo, debolezze e copertura offensiva.",
    "team.my_team": "Il mio team",
    "team.opp_team": "Avversario",
    "team.clear": "Cancella",
    "team.search_placeholder": "Aggiungi un Pokémon…",
    "team.empty_prompt": "Aggiungi Pokémon al tuo team per iniziare l'analisi.",
    "team.no_opp_prompt": "Aggiungi Pokémon al team avversario per vedere il matchup.",
    "team.section.defensive": "Debolezze difensive",
    "team.section.defensive_desc": "Tipi d'attacco che colpiscono super efficacemente almeno un membro del team, ordinati per pericolosità.",
    "team.section.matchup": "Matchup copertura tipi",
    "team.section.matchup_desc": "Efficacia STAB e vulnerabilità di tipo per entrambi i team.",
    "team.section.stats": "Statistiche medie",
    "team.my_stab_coverage": "Copertura STAB",
    "team.my_weaknesses": "Debolezze di tipo",
    "team.opp_stab_threats": "Copertura STAB",
    "team.opp_weaknesses": "Debolezze di tipo",
    "team.matrix.coverage_hint": "copertura contro il loro team",
    "team.matrix.threats_hint": "minacce contro il tuo team",
    ...
    "team.stored.eyebrow": "Archivio locale",
    "team.stored.title": "Team salvati",
    "team.stored.subtitle": "Salva il team corrente in locale con IV, EV, natura, abilità e fino a quattro mosse per Pokémon.",
    "team.stored.load_subtitle": "Carica un team locale su uno dei due lati del matchup, oppure modifica i dettagli della build salvata.",
    "team.stored.name_placeholder": "Nome team",
    "team.stored.save_current": "Salva",
    "team.stored.empty": "Nessun team salvato. Aggiungi Pokémon al tuo team, dai un nome e salvalo qui.",
    "team.stored.default_name": "Team {count}",
    "team.stored.expand": "Espandi team salvato",
    "team.stored.collapse": "Comprimi team salvato",
    "team.stored.import": "Importa",
    "team.stored.load": "Carica",
    "team.stored.load_as_my": "Carica come tuo team",
    "team.stored.load_as_opp": "Carica come avversario",
    "team.stored.my_short": "Mio",
    "team.stored.opp_short": "Avv",
    "team.stored.edit": "Modifica",
    "team.stored.compare_lead": "Confronta lead",
    "team.stored.delete": "Elimina",
    "team.stored.compare_a": "Confronta A",
    "team.stored.compare_b": "Confronta B",
    "team.stored.no_nature": "Nessuna natura",
    "team.stored.no_matching_natures": "Nessuna natura trovata",
    "team.stored.moves": "Mosse conosciute",
    "team.stored.move_slot": "Mossa {slot}",
    "team.stored.move_search_placeholder": "Cerca mossa",
    "team.stored.no_matching_moves": "Nessuna mossa trovata",
    "team.stored.no_move": "Nessuna mossa",

    "compare.stored.title": "Build salvate",
    "compare.stored.subtitle": "Importa una build locale per precompilare IV, EV, natura, abilità e mosse conosciute.",
    "compare.stored.import_a": "Importa in A",
    "compare.stored.import_b": "Importa in B",
    "compare.stored.none": "Seleziona build",
    "compare.stored.known_moves": "Mosse salvate attive",
    "compare.stored.known_move": "Salvata",

    "team_save.back": "Torna al Team",
    "team_save.title_new": "Salva team",
    "team_save.title_edit": "Modifica team",
    "team_save.subtitle": "Dai un nome al team e imposta IV, EV, natura, abilità e mosse conosciute per ogni Pokémon.",
    "team_save.save": "Salva team",
    "team_save.duplicate": "Duplica",
    "team_save.duplicate_name": "Copia di {name}",
    "team_save.add_pokemon": "Aggiungi Pokémon",
    "team_save.compare_pokemon": "Confronta {name}",
    "team_save.remove": "Rimuovi",
    "team_save.remove_pokemon": "Rimuovi {name}",
    "team_save.team_full": "Team completo",
    "team_save.status_new": "Non ancora salvato",
    "team_save.status_saved": "Nessuna modifica non salvata",
    "team_save.status_unsaved": "Modifiche non salvate",
    "team_save.empty": "Nessun membro del team fornito. Costruisci prima un team, poi salvalo.",
    "team_save.loading_pokemon": "Caricamento Pokémon",
  },
};
